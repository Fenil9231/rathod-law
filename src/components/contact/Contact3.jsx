  ...
  <div className="container">
    <div className="row align-items-start gy-5">
      <div className="col-xl-7 col-lg-7">
        ...
        <form className="contact-form contact-form3" onSubmit={handleSubmit}>
          <div className="row">
              ...
              <div className="consent-checkboxes" style={{marginBottom: '20px'}}>
                <div className="form-check mb-3">
                  <input 
                    ...
                    type="checkbox" 
                    id="contact3SmsConsent" 
                    name="smsConsent"
                    checked={formData.smsConsent}
                    onChange={handleInputChange}
                    required
                  />
                  <label className="form-check-label text-white" htmlFor="contact3SmsConsent" style={{fontSize: '14px', lineHeight: '1.5'}}>
                ...
                <div className="form-check mb-3">
                  <input 
                    className="form-check-input" 
                    type="checkbox" 
                    id="contact3MarketingConsent"
                    name="marketingConsent"
                    checked={formData.marketingConsent}
                    onChange={handleInputChange}
                  />
                  <label className="form-check-label text-white" htmlFor="contact3MarketingConsent" style={{fontSize: '14px', lineHeight: '1.5'}}>
                    I Consent to Receive Occasional Marketing Communication from Rathod Law Firm.
                  </label>
                </div>
                <p style={{fontSize: '12px', color: '#ccc', marginBottom: '0'}}>
