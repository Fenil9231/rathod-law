          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-6 col-lg-4 col-md-3 d-md-flex d-none justify-content-end">
              <div className="slider-arrows banner2-arrows text-center d-sm-flex d-none flex-row justify-content-center align-items-center gap-4">
                <div
                  className="case2-prev swiper-prev-arrow"
                  tabIndex={0}
                  role="button"
                ...
                <div
                  className="case2-next swiper-next-arrow"
                  tabIndex={0}
                  role="button"
                ...
                {caseData2.map((item) => {
                  return (
                    <SwiperSlide key={item.id} className="swiper-slide">
                      <div
                        className="casestudy-single2 wow fadeInDown"
                      ...
                      >
                        ...
                        <div className="content-wrapper">
                          <div className="content">
                            ...
                            <Link href="/casestudy-details">
                              <a className="details-btn">Read More</a>
                            </Link>
                          </div>
                        </div>
                      </div>
