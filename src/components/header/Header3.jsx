    ...
    <div className={showMobileMenu === 1 ? "main-nav show-menu" :"main-nav"}>
      <div className="mobile-logo-area d-xl-none d-flex justify-content-between align-items-center">
        <div className="mobile-logo-wrap ">
          <Link href="/"><a><img alt="Rathod Law Firm" src="assets/images/logo/Rathod-logo-white.png" style={{height: '50px', width: 'auto'}} /></a></Link>
        </div>
      ...
      <ul className="menu-list">
        <li className="menu-item-has-children" onClick={() => dispatch({type: 'home'})}>
          ...
          <ul className={state.activeMenu ==='home' ? "sub-menu d-block" : "sub-menu d-none"}>
            ...
            <li><Link href="/index3" ><a className="active-menu">Home 3</a></Link></li>
