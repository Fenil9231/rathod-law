...
function LayoutHeader() {
  ...
  <Link href="/"><img alt="Rathod Law Firm" src="assets/images/logo/Rathod-logo-white.png" style={{height: '50px', width: 'auto'}} /></Link>
</div>
  ...
  <div  className={showMobileMenu === 1 ? "main-nav show-menu" :"main-nav"}>
    ...
    <ul className="menu-list">
      ...
      <li li className="menu-item-has-children" onClick={() => dispatch({type: 'case'})}>
        ...
        <ul className={state.activeMenu ==='cse' ? "sub-menu d-block" : "sub-menu d-none"}>
