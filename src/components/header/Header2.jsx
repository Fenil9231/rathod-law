...
function reducer(state, action) {
  switch (action.type) {
    case "team":
      return { activeMenu: "team" };
    case "paralegal":
      return { activeMenu: "paralegal" };
    case "lawyer":
      return { activeMenu: "lawyer" };
    case "immigration":
      return { activeMenu: "immigration" };
    case "contact":
    ...
    <>
      <header className="header-area style-2">
        <div className="header-logo">
          <Link href="/">
            <a>
              <img alt="Rathod Law Firm" src="assets/images/logo/Rathod-logo-white.png" style={{height: '50px', width: 'auto'}} />
            </a>
          </Link>
        </div>
        <div
        ...
        >
          <div className="mobile-logo-area d-xl-none d-flex justify-content-between align-items-center">
            <div className="mobile-logo-wrap ">
              <Link href="/">
                <a>
                  <img alt="Rathod Law Firm" src="assets/images/logo/Rathod-logo-white.png" style={{height: '40px', width: 'auto'}} />
                </a>
              </Link>
            </div>
          ...
          <ul className="menu-list">
            <li className="menu-item-has-children" onClick={() => dispatch({type: 'team'})}>
              <a
                href="#"
                className={
                  state.activeMenu === "team"
                    ? "active drop-down"
                    : "drop-down"
                }
              >
              ...
              >
                ...
                <li>
                  <Link href="/saleema-panjwani">
                    <a>Saleema Panjwani</a>
                  </Link>
                </li>
                <li>
                  <Link href="/lincy-gomez">
                    <a>Lincy Gomez</a>
                  </Link>
                </li>
              </ul>
            </li>
            <li className="menu-item-has-children" onClick={() => dispatch({type: 'paralegal'})}>
              <a
                href="#"
                className={
                  state.activeMenu === "paralegal" ? "active drop-down" : "drop-down"
                }
              >
                PARALEGAL SERVICES
              </a>
              ...
              <ul
                className={
                  state.activeMenu === "paralegal"
                    ? "sub-menu d-block"
                    : "sub-menu d-none"
                }
              >
                <li>
                  <Link href="/speeding-tickets">
                    <a>Speeding Tickets</a>
                  </Link>
                </li>
                <li>
                  <Link href="/cell-phone-tickets">
                    <a>Cell Phone Tickets/Distracted Driving</a>
                  </Link>
                </li>
                <li>
                  <Link href="/seat-belt-tickets">
                    <a>Seat Belt Tickets</a>
                  </Link>
                </li>
                <li>
                  <Link href="/red-light-tickets">
                    <a>Red Light Tickets</a>
                  </Link>
                </li>
                <li>
                  <Link href="/stunt-driving">
                    <a>Stunt Driving Tickets</a>
                  </Link>
                </li>
                <li>
                  <Link href="/license-suspension">
                    <a>Suspended Driver's License</a>
                  </Link>
                </li>
                <li>
                  <Link href="/demerit-points">
                    <a>Demerit Points</a>
                  </Link>
                </li>
                <li>
                  <Link href="/small-claims-court">
                    <a>Small Claims Court Cases</a>
                  </Link>
                </li>
              </ul>
            </li>
            <li className="menu-item-has-children" onClick={() => dispatch({type: 'lawyer'})}>
              <a
                href="#"
                className={
                  state.activeMenu === "lawyer"
                    ? "active drop-down"
                    : "drop-down"
                }
              >
            ...
            <li className="menu-item-has-children" onClick={() => dispatch({type: 'contact'})}>
              <a
                href="#"
                className={
          ...
          <div className="phone-call d-flex justify-content-start align-items-center flex-row d-xl-none d-block mt-5">
            ...
            <div className="number">
              ...
              <h5>
                <a href="tel:+1-604-593-6777">+1 (604) 593-6777</a>
              </h5>
            </div>
          </div>
        </div>
