      ...
      <div className="row gy-5">
        <div className="col-lg-3 col-md-6">
          <div className="footer-about">
            <img src="assets/images/logo/Rathod-logo-white.png" alt="Rathod Law Firm" style={{height: '60px', width: 'auto', marginBottom: '15px'}} />
            <p>Providing expert legal services in immigration, family law, traffic violations, and notarization. Your trusted legal partner in Ontario.</p>
            <ul className="footer-social gap-4">
              <li><a href="https://www.facebook.com/rathodlawfirm"><i className="bx bxl-facebook" /></a></li>
              <li><a href="https://www.twitter.com/rathodlawfirm"><i className="bx bxl-twitter" /></a></li>
              <li><a href="https://www.instagram.com/rathodlawfirm"><i className="bx bxl-instagram" /></a></li> 
            </ul>
        ...
        <div className="col-lg-3 col-md-6 d-flex justify-content-lg-center">
          <div className="footer-item">
            ...
            <ul className="link-list">
              <li><Link href="/immigration-appeals"><a>Immigration Appeals</a></Link></li>
              <li><Link href="/refugee-appeals"><a>Refugee Appeals</a></Link></li>
              <li><Link href="/immigration-applications"><a>Immigration Applications</a></Link></li>
              <li><Link href="/family-law"><a>Family Law</a></Link></li>
              <li><Link href="/speeding-tickets"><a>Traffic Violations</a></Link></li>
              <li><Link href="/notarization"><a>Notarization Services</a></Link></li>
            </ul>
          </div>
        </div>
        <div className="col-lg-3 col-md-6 d-flex justify-content-lg-center">
          <div className="footer-item">
            ...
            <ul className="contact-list">
              <li>
                ...
                <div className="text">
                  <a href="tel:+16476549454">(647) 654-9454</a> 
                  <a href="tel:+14378809656" className="mb-0">(437) 880-9656</a>
                </div>
              </li>
              <li>
                <div className="icon">
                ...
                <div className="text">
                  <a href="mailto:rathod@hplaw.org" className="mb-0">rathod@hplaw.org</a>
                </div>
              </li>
              <li>
                <div className="icon">
                ...
                <div className="text">
                  123 Main Street, Suite 456, Toronto, ON M5V 3A8, Canada
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="col-lg-3 col-md-6 d-flex justify-content-lg-end">
          <div className="footer-item">
            ...
            <ul className="recent-caselist">
              <li>
                <div className="image">
                  <img src="assets/images/blog/recent-case1.png" alt="Immigration Services" />
                </div>
                <div className="text">
                  <span>Services</span>
                  <h5><Link href="/immigration-appeals"><a>Immigration Appeals</a></Link></h5>
                </div>
              </li>
              <li>
                <div className="image">
                  <img src="assets/images/blog/recent-case2.png" alt="Family Law Services" />
                </div>
                <div className="text">
                  <span>Services</span>
                  <h5><Link href="/family-law"><a>Family Law</a></Link></h5>
                </div>
              </li>
              <li>
                <div className="image">
                  <img src="assets/images/blog/recent-case3.png" alt="Traffic Violations" />
                </div>
                <div className="text">
                  <span>Services</span>
                  <h5><Link href="/speeding-tickets"><a>Traffic Violations</a></Link></h5>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div className="footer-bottom">
      <div className="row d-flex align-items-center g-3">
        <div className="col-lg-6 d-flex justify-content-lg-start justify-content-center text-lg-start text-center px-1">
          <p>Copyright {new Date().getFullYear()} <Link href="/"><a className="egns-lab">Rathod Law Firm</a></Link> | All Rights Reserved</p>
        </div>
        <div className="col-lg-6 d-flex justify-content-lg-end justify-content-center align-items-center">
          <ul className="f-bottom-list d-flex justify-content-start align-items-center gap-3 list-unstyled mb-0">
            <li className="footer-policy-link">
              <Link href="/cookie-policy">
                <a className="text-decoration-none text-light opacity-75 hover-opacity-100 transition-opacity">Cookie Policy</a>
              </Link>
            </li>
            <li className="footer-policy-link">
            ...
            <li className="footer-policy-link">
              <Link href="/privacy-policy">
                <a className="text-decoration-none text-light opacity-75 hover-opacity-100 transition-opacity">Privacy Policy</a>
              </Link>
            </li>
            <li className="footer-policy-link">
              <span className="text-muted mx-2">|</span>
            ...
            <li className="footer-policy-link">
              <Link href="/terms-conditions">
                <a className="text-decoration-none text-light opacity-75 hover-opacity-100 transition-opacity">Terms & Conditions</a>
              </Link>
            </li>
          </ul>
        </div>
