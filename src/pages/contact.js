...
function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Contact Rathod Law Firm - Expert Legal Services in Toronto</title>
        <meta name="description" content="Contact Rathod Law Firm for expert legal services in immigration, traffic violations, family law, and notarization. Schedule a free consultation today." />
        <meta name="keywords" content="contact lawyer Toronto, legal consultation, immigration lawyer contact, traffic lawyer Toronto, family law attorney contact" />
        <meta name="author" content="Rathod Law Firm" />
        <meta property="og:title" content="Contact Rathod Law Firm - Expert Legal Services" />
        <meta property="og:description" content="Get in touch with our experienced legal team for immigration, traffic, and family law matters. Free consultation available." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://rathodlaw.com/contact" />
        <link rel="canonical" href="https://rathodlaw.com/contact" />
        <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "ContactPage",
          "name": "Contact Rathod Law Firm",
          "description": "Contact Rathod Law Firm for expert legal services in immigration, traffic violations, family law, and notarization. Schedule a free consultation today.",
                  ...
                  <div className="address-area">
                    ...
                    <ul className="address-list sibling3">
                      ...
                      <li>
                        ...
                        <div className="text">
                          <h4>Phone</h4>
                          <a href="tel:+16476549454">
                            (647) 654-9454
                          </a>{" "}
                          <br />
                          <a href="tel:+14378809656">(437) 880-9656</a>
                        </div>
                      </li>
                      <li>
                        <div className="icon">
                        ...
                        <div className="text">
                          <h4>Email</h4>
                          <a href="mailto:rathod@hplaw.org">
                            rathod@hplaw.org
                          </a>
                        </div>
                      </li>
                        ...
                        <div className="consent-checkboxes" style={{marginBottom: '20px'}}>
                          <div className="form-check mb-3">
                            <input 
                              ...
                              required
                            />
                            <label className="form-check-label" htmlFor="contactSmsConsent" style={{fontSize: '14px', lineHeight: '1.5'}}>
                          ...
                          <div className="form-check mb-3">
                            <input 
                              ...
                              onChange={handleInputChange}
                            />
                            <label className="form-check-label" htmlFor="contactMarketingConsent" style={{fontSize: '14px', lineHeight: '1.5'}}>
