        ...
        <div className="blog-standard-area">
          <div className="blog-standard-single">
            <div className="image">
              ...
              <Link href="/blog-details"><img src="assets/images/blog/blog-stand1.png" className="img-fluid" alt="image" /></Link>
            </div>
            <div className="text">
              <h2><Link href="/blog-details">Nullam feugiat et quam in accumsan this is awsome blog.</Link></h2>
              ...
              <Link href="/blog-details" className="read-more-btn">Continue Reading<i className="bi bi-arrow-right" /></Link>
            </div>
          </div>
          <div className="blog-standard-single">
            <div className="image">
              <span className="blog-badge">Violence</span>
              <Link href="/blog-details"><img src="assets/images/blog/blog-stand2.png" className="img-fluid" alt="image" /></Link>
            </div>
            <div className="text">
              <h2><Link href="/blog-details">Pellentesque convallis fermentum leo. this is awsome blog.</Link></h2>
              <ul className="post-meta-list">
                <li><img src="assets/images/icons/user.svg" alt="image" /><span>By, Admin</span></li>
                <li><img src="assets/images/icons/calendr.svg" alt="image" /><span>25 May, 2022</span></li>
                <li><img src="assets/images/icons/bubble.svg" alt="image" /><span>Comments (02)</span></li>
          ...
          <div className="blog-standard-single">
            <div className="image">
              <span className="blog-badge">Violence</span>
              <Link href="/blog-details"><img src="assets/images/blog/blog-stand3.png" className="img-fluid" alt="image" /></Link>
            </div>
            <div className="text">
              <h2><Link href="/blog-details">Integer et mauris id purus consequat this is awsome blog.</Link></h2>
              <ul className="post-meta-list">
                <li><img src="assets/images/icons/user.svg" alt="image" /><span>By, Admin</span></li>
                <li><img src="assets/images/icons/calendr.svg" alt="image" /><span>25 May, 2022</span></li>
                <li><img src="assets/images/icons/bubble.svg" alt="image" /><span>Comments (02)</span></li>
