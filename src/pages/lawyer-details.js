  ...
  return (
    <>
      <Head>
        ...
        <title>Demo Lawyer Details - Not for Search Engines</title>
      </Head>
     <Layout>
          ...
          <div className="lawyer-profile text-xl-start text-center">
            ...
            <div className="lawyer-short-details">
              ...
              <ul className="details-list">
                ...
                <li>
                  <span>Address:</span>
                  <h5>5500 North Service Road, Suite 300, Burlington, ON L7L 6W6</h5>
                </li>
                <li>
                  <span>Fax: </span>
                  <h5>123 456 789</h5>
      ...
      <div className="col-lg-9">
        <div className="tab-content" id="v-pills-tabContent">
          ...
          <div className="tab-pane fade text-lg-start text-center" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
            ...
            <ul className="lawyer-edu-list">
              <li><span>Law Society of Ontario - </span>Licensed to practice law in Ontario, Canada, with expertise in immigration law, traffic violations, and family law matters.</li>
              <li><span>Canadian Bar Association - </span>Active member of the Canadian Bar Association, staying current with legal developments and best practices in Canadian law.</li>
            </ul>
          </div>
          <div className="tab-pane fade text-lg-start text-center" id="v-pills-order" role="tabpanel" aria-labelledby="v-pills-order-tab">
            ...
            <ul className="lawyer-edu-list">
              <li><span>Ontario Superior Court of Justice - </span>Extensive experience representing clients in various matters before the Ontario Superior Court of Justice, including family law disputes, immigration appeals, and civil litigation.</li>
            </ul>
          </div>
        </div>
      </div>
