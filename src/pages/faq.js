    ...
    try {
      ...
      if (response.ok) {
        setSubmitStatus({
          ...
          message: 'Thank you! Your question has been submitted successfully. We will get back to you soon.'
        });
        setShowModal(true);
        setFormData({
          name: '',
        ...
        setSubmitStatus({
          ...
          message: result.message || 'There was an error submitting your question. Please try again.'
        });
        setShowModal(true);
      }
    } catch (error) {
      ...
      <div className="col-lg-4 order-lg-1 order-2">
        ...
        <div className="faq-sidebar">
          ...
          <form className="faq-form" onSubmit={handleSubmit}>
            ...
            <div className="consent-checkboxes" style={{marginBottom: '15px'}}>
              <div className="form-check mb-2">
                <input 
                  ...
                  required
                />
                <label className="form-check-label" htmlFor="faqSmsConsent" style={{fontSize: '12px', lineHeight: '1.4'}}>
              ...
              <div className="form-check mb-2">
                <input 
                  className="form-check-input" 
                  type="checkbox" 
                  id="faqMarketingConsent"
                  name="marketingConsent"
                  checked={formData.marketingConsent}
                  onChange={handleInputChange}
                />
                <label className="form-check-label" htmlFor="faqMarketingConsent" style={{fontSize: '12px', lineHeight: '1.4'}}>
            ...
            <button type="submit" className="eg-btn btn--primary2 btn--md rounded-1 w-100" disabled={isSubmitting}>
