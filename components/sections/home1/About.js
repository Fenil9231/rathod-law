...
export default function About() {
    ...
    const [aboutContent, setAboutContent] = useState({
        ...
        sectionTitleText: "welcome to rathod law",
        sectionMainTitle: "Professional Legal Services with Personal Attention",
        aboutText:
            "At Rathod Law Professional Corporation, we provide comprehensive legal services specializing in traffic violations, immigration law, and family matters. Our experienced team is dedicated to protecting your rights and achieving the best possible outcomes for your case.",
        learnMoreLink: "/about",
        ...
        counters: [
            ...
            { icon: "icon-icon-15", count: 95, suffix: "%", title: "Client Satisfaction Rate" },
        ],
    });
